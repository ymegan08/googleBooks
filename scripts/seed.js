...
const booksSeed = [
  {
    ...
    image:
      "https://books.google.com/books/content?id=8lINUTi_GBYC&printsec=frontcover&img=1&zoom=1&edge=curl&source=gbs_api"
  },
  {
    authors: ["Jen Wilkin"],
    ...
    link:
      "https://books.google.com/books?id=uXQMvgAACAAJ&dq=title:jen+wilkin&hl=&source=gbs_api",
    description:
    ...
    image:
      "https://books.google.com/books/content?id=uXQMvgAACAAJ&printsec=frontcover&img=1&zoom=1&source=gbs_api"
  }
];
